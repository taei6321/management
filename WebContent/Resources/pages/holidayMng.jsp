...
<div id="wrapper">
     ...
     <div id="page-wrapper">
        <form name="find" method="post" action="/namowebiz/FindBusiDateServlet.do">
                            ...
                            <table style="width:100%" class="table table-striped table-bordered table-hover" id="data-example">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">남은연차일수</th>
                                        <th class="text-center">총연차일수</th>
                                        <th class="text-center">비고</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <%
	                                ArrayList<User> hoList = userDao.userSelect();
	        						float hWidth = 0.0f;
                               		...
                               		if (hoList != null) {
  	        							for (User i : hoList) {
  	        								...
  	        								if(i.getUser_holidays_total()-i.getUser_holidays_use() < 0){
  	        									%>
  	                                			<tr class="odd gradeX">
  	   	                                        <td class="text-center"><a href="holidayMngInfo.jsp?holiID=<%= i.getUser_id() %>"><%= i.getUser_id() %></a></td>
  	   	                                        <td class="text-center"><%= i.getUser_name()%></td>
  	   	                                        <td class="text-center"><%= i.getUser_holidays_total()-i.getUser_holidays_use()%></td>
  	   	                                        <td class="text-center"><%= i.getUser_holidays_total() %></td>
  	   	                                        <td class="text-center">연차일수 초과</td>
  	                                      		</tr>
  	                                 			<%
  	        								}else{
  	        									%>
            ...
            <div class="row">
           		<div class="col-lg-12">
           		   <div class="col-lg-4"><a data-target="#insertHoli" data-toggle="modal" class="btn btn-default btn-lg btn-block">연차추가</a></div>
		           <div class="col-lg-4"><a data-target="#holiday" data-toggle="modal" class="btn btn-default btn-lg btn-block">연차등록</a></div>
		           <div class="col-lg-4"><a class="btn btn-default btn-lg btn-block" href="index.jsp">메인화면</a></div>
            	</div>
       		</div>
        </div>
        <!-- /#page-wrapper -->
    ...
    <!-- 연차 일 수 추가 모달창 -->
    <div class="row">
    	<div class="modal" id="insertHoli" tabindex="-1">
    		<div class="modal-dialog">
    			<div class="modal-content">
					...
					<div class="modal-body">
						<form method="post" action="/namowebiz/HolidayInsertServlet.do">
							
							<div class="form-group">
								<div class="col-lg-12">
									<div class="col-lg-6">
										<select class="form-control" name="user_id" style="text-align-last:center; float:left">
									...
									<div class="col-lg-6">
										<p class="text-center" style="float:left">
											<input class="form-control" type="number" id="holidayIn" name="holidayIn" size="25%" placeholder="연차일수를 입력하세요." min="0"></input>
										</p>
									</div>
    	...
    	<div class="modal" id="holiday" tabindex="-1">
    		<div class="modal-dialog">
    			<div class="modal-content">
					...
					<div class="modal-body">
						<form method="post" action="/namowebiz/HolidayMngServlet.do">
							...
							<div class="form-group" style="width:100%; margin: auto;">
								...
								<select class="form-control" name="user_id" style="text-align-last:center">
									<option value="">이름(사번)</option>
									<% 	userDAO = new UserDAO();
										ArrayList<User> hUlist = userDAO.userSelect();
										if(hUlist != null){
											for(User i : hUlist){
											%>
									<option value="<%=i.getUser_id()%>"><%= i.getUser_name()%>(<%=i.getUser_id()%>)</option>
