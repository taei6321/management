...
<%@page import="com.namowebiz.publicHoliday.PublicHoliday"%>
...
<div id="wrapper">
        ...
        <form name="find" method="post" action="/namowebiz/FindBusiDateServlet.do">
            <div class="row">
               <div class="col-lg-12" style="margin: auto">
					 <h1 class="page-header">공휴일 등록현황</h1>
                            ...
                            <table style="width:100%" class="table table-striped table-bordered table-hover" id="data-example">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">공휴일명</th>
                                        <th class="text-center">공휴일 날짜</th>
                                ...
                                <%
                                	...
                                	ArrayList<PublicHoliday> list = publicHolidayDAO.userSelect();
	                                int num = 1;
	                                 if(list != null){
	                                 	for(PublicHoliday i : list){
	                                 			%>
                                 			<tr class="odd gradeX">
    	                                        <td class="text-center"><input type="hidden" id="tr_pk_<%= num %>" value="<%=i.getHolidays_num()%>"></input><%= num %></td>
    	                                        <td class="text-center"><input type="hidden" id="tr_holiName_<%= num %>" value="<%=i.getHolidays_name()%>"></input><a data-target="#update" data-toggle="modal" class="btn" onclick="update_modal(<%=num%>);"><%=i.getHolidays_name()%></a></td>
    	                                        <td class="text-center"><input type="hidden" id="tr_update_<%= num %>" value="<%=i.getHolidays_date()%>"></input><%=i.getHolidays_date()%></td>
            ...
            <div class="row">
           		<div class="col-lg-12">
		           <div class="col-lg-6"><a data-target="#holiday" data-toggle="modal" class="btn btn-default btn-lg btn-block">공휴일등록</a></div>
	...
	function update_modal(str){
		$("#updateName").val($("#tr_holiName_"+str).val());
		$("#upDate").val($("#tr_update_"+str).val());
		$("#holidayPK").val($("#tr_pk_"+str).val());
	}
    		...
    		<div class="modal-dialog">
    			<div class="modal-content">
					...
					<div class="modal-body">
						<form method="post" action="/namowebiz/PublicHolidayServlet.do">
							
							<div class="form-group" style="width:100%; margin: auto;">
							
								<div class="col-lg-12">
									<div class="col-lg-6">
										<input class="form-control" type="text" id="holidayName" name="holidayName" size="25%" placeholder="공휴일명을 입력하세요." style="text-align:center"></input>
									</div>
									<div class="col-lg-6">
										<input class="form-control" type="text" id="holidayDate" name="holidayDate" size="25%" placeholder="날짜를 입력하세요." style="text-align:center"></input>
									</div>
								</div>
								 <script src="../js/jquery-1.11.0.min.js"></script>
								  <script src="../js/bootstrap-datepicker.js"></script>
								  ...
								  <script>
								  $(function() {
						               $("#holidayDate").datepicker({ dateFormat: "yy-mm-dd" }).val()
						       	  });
								  $( function() {
								    var dateFormat = "yy-mm-dd",
								    	holidayDate = $( "#holidayDate" ).datepicker({
								        defaultDate: "+1w",
								        changeMonth: true,
								        numberOfMonths: 1
								        });
					...
					<div class="modal-body">
						<form method="post" action="/namowebiz/PublicHolidayServlet.do">
							...
							<div class="form-group" style="width:100%; margin: auto;">
								...
								<div class="col-lg-12">
									<div class="col-lg-6">
										<input class="form-control" type="text" id="updateName" name="updateName" size="25%" value="" style="text-align:center"></input>
									</div>
									<div class="col-lg-6">
										<input class="form-control" type="text" id="upDate" name="upDate" size="25%" value="" style="text-align:center"></input>
										<input type="hidden" id="holidayPK" name="holidayPK" value=""></input>
									</div>
								</div>
								 <script src="../js/jquery-1.11.0.min.js"></script>
								  <script src="../js/bootstrap-datepicker.js"></script>
								  ...
								  <script>
								  $(function() {
						               $("#upDate").datepicker({ dateFormat: "yy-mm-dd" }).val()
						       	  });
								  $( function() {
								    var dateFormat = "yy-mm-dd",
								    	upDate = $( "#upDate" ).datepicker({
								        defaultDate: "+1w",
								        changeMonth: true,
								        numberOfMonths: 1
								        });
