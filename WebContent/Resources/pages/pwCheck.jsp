        ...
        <div id="page-wrapper">
            ...
            <!-- 여기에 프로필 들어가야함! -->
              ...
              <div class="col-lg-12">
                  ...
                  <form method="post" action="/namowebiz/PwCheckServlet.do">
                    <div class="inputBox">
                    	<br/>
                    	<p class="text-center"><input type="password" name="user_pw" placeholder="비밀번호를 입력하세요." style="width:100%; text-align:center; font-size:18pt"/></p>
                    </div><br/>
