...
<div id="wrapper">
                              ...
                              <tbody>
                              		<tr class="odd gradeX">
                                        ...
                                        <td class="text-center">
                                        	<input type="text" name="userId" maxlength="10" placeholder="사번" value="<%= session.getAttribute("id")%>"/>
                                        	<input type="button" class="btn btn-default" value="중복확인" onclick="id_check();"></input>
                                        </td>
                                 	</tr>
                                 	<tr class="odd gradeX">
                              			<td class="text-center"><b>비밀번호</b></td>
                                        <td class="text-center"><input type="password" name="user_pw" maxlength="20" placeholder="비밀번호"/></td>
                                 	</tr>
                                 	<tr class="odd gradeX">
                              			<td class="text-center"><b>이름</b></td>
                                        <td class="text-center"><input type="text" name="user_name" maxlength="24" placeholder="이름"/></td>
                                 	</tr>
                                    <tr class="odd gradeX">
                              			<td class="text-center"><b>부서</b></td>
                                        <td class="text-center"><input type="text" name="user_part" maxlength="24" placeholder="부서"/></td>
                                 	</tr> 
                                    <tr class="odd gradeX">
                              			<td class="text-center"><b>직급</b></td>
                                        <td class="text-center"><input type="text" name="user_rank" maxlength="24" placeholder="직급"/></td>
                                 	</tr>     
                                    <tr class="odd gradeX">
                              			<td class="text-center"><b>연락처</b></td>
                                        <td class="text-center"><input type="text" name="user_phone" maxlength="24" placeholder="연락처"/></td>
                                 	</tr>
                                 	<tr class="odd gradeX">
                              			<td class="text-center"><b>이메일</b></td>
                                      	<td class="text-center"><input type="email" name="user_email" maxlength="256" placeholder="이메일"/></td>
                                 	</tr>
                                 	<tr class="odd gradeX">
                              			<td class="text-center"><b>연차일수</b></td>
                                        <td class="text-center"><input type="number" name="user_holidays" maxlength="256" placeholder="연차일수" min="0"/></td>
                                 	</tr>
                            ...
                            <div class="col-lg-12">
	                            <div class="col-lg-6">
		                            <div class="col-centered">
		                               <input type="button" class="btn btn-default btn-lg btn-block" value="추가" onclick="insert_user();"/>
		                            </div>
	                            </div>
	                            <div class="col-lg-6">
	                             	<div class="col-centered">
		                               <input type="button" class="btn btn-default btn-lg btn-block" value="되돌아가기" onclick="re_list();"/>
		                            </div>
	                            </div>
                            </div>
    ...
    <script>
	    function id_check(){
			...
			f.action="/namowebiz/IDCheck.do";
			f.submit();
		}
    	function insert_user(){
    		var f=document.insertForm;
    		f.action="/namowebiz/InsertServlet.do";
    		f.submit();
    	}
    	function re_list(){
    		var f=document.insertForm;
