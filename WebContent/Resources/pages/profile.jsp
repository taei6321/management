                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
              		...
              		<ul class="dropdown-menu dropdown-user nav nav-pills">
              			<li role="presentation" class="active"><a href="./profile.jsp"><i class="fa fa-user fa-fw"></i> 프로필</a>
                        </li>
            ...
            <!-- 여기에 프로필 들어가야함! -->
              ...
              <div class="col-lg-12">
                  <div class="table-responsive">
					...
					<input type="submit" class="btn btn-outline btn-primary btn-lg btn-block" value="설정"></input>
                      <%}} %>
                      </form> 
                  </div>
            </div>
