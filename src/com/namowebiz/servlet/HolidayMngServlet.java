...
public class HolidayMngServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String holiday_id = req.getParameter("user_id");
				...
				if(r == -1) {
					...
					if(reason != null) {
						...
						if(value[i1].equals("allDay")) {
							...
							int holidays = 0;
							if(list != null) {
								for(Holiday i111 : list1) {
									holidays = i111.getHolidays_day();
